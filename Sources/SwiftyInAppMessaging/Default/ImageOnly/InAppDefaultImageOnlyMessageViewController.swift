    ...
    final class InAppDefaultImageOnlyMessageViewController: UIViewController {
        ...
        private func applyPortraitLayout() {
            currentConstraints.append(contentsOf: [
                ...
                self.imageOnlyView.leftAnchor.constraint(
                    equalTo: self.view.readableContentGuide.leftAnchor),
                self.imageOnlyView.rightAnchor.constraint(
        ...
        private func applyLandscapeLayout() {
            currentConstraints.append(contentsOf: [
                self.imageOnlyView.centerXAnchor.constraint(equalTo: self.view.centerXAnchor),
                self.imageOnlyView.topAnchor.constraint(
                    equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: 8),
                self.imageOnlyView.bottomAnchor.constraint(
